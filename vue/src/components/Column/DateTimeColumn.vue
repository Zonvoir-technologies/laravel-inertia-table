...
import { formatDateValue } from '../../helpers/formatDateValue';
...
const props = defineProps<DateTimeColumnProps>();
const rawValue: ComputedRef<TableCellValue> = useRawValue(props.column, props.row);
const displayValue: ComputedRef<string> = computed((): string => formatDateValue(props.column, rawValue.value));
</script>
